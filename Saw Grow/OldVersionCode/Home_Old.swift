...
class Home_Old: UIViewController, OverlayContainerViewControllerDelegate, UIScrollViewDelegate {
...
extension Home_Old: UICollectionViewDataSource {
...
extension Home_Old: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout,
        ...
        if collectionView == categoryCollectionView {//Category
            return CGSize(width: 82 , height: collectionView.frame.height)
        }
        else if collectionView == announcementCollectionView {//Announcement
...
extension Home_Old: UICollectionViewDelegate {
