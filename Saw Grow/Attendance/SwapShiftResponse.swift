...
class SwapShiftResponse: UIViewController  {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        loadResponse(withLoadingHUD: true)
    }
...
//            }
    ...
    func loadResponse(withLoadingHUD:Bool) {
        let parameters:Parameters = ["group":"response"]
...
extension SwapShiftResponse: UICollectionViewDataSource {
...
extension SwapShiftResponse: UICollectionViewDelegateFlowLayout {
...
extension SwapShiftResponse: UICollectionViewDelegate {
