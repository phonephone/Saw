...
class Home: UIViewController, OverlayContainerViewControllerDelegate,
    UIScrollViewDelegate
{
    ...
    override func viewDidLoad() {
        ...
        myScrollView.contentInset = UIEdgeInsets(
        ...
        popupView.frame = CGRect(
            x: (self.view.bounds.width - popupWidth) / 2,
            y: (self.view.bounds.height / 2) - (popupHeight / 2),
    ...
    func loadHome() {
        quickBtn1.isUserInteractionEnabled = false
        quickBtn2.isUserInteractionEnabled = false
        quickBtn3.isUserInteractionEnabled = false
        quickBtn4.isUserInteractionEnabled = false
        ...
        loadRequest(
            method: .post, apiName: "auth/gethome", authorization: true,
            showLoadingHUD: true, dismissHUD: true, parameters: parameters
        ) { [self] result in
            switch result {
            ...
            case .success(let responseObject):
                ...
                if theme.count > 0 {
                    if theme[0]["background_color1"].stringValue != "" {
                        let color = colorFromRGB(
                            rgbString: theme[0]["background_color1"].stringValue
                        )
                        UserDefaults.standard.saveColor(
                            color, forKey: "gradientColor_1")
                    } else {
                        UserDefaults.standard.removeObject(
                            forKey: "gradientColor_1")
                    }

                    if theme[0]["background_color2"].stringValue != "" {
                        let color = colorFromRGB(
                            rgbString: theme[0]["background_color2"].stringValue
                        )
                        UserDefaults.standard.saveColor(
                            color, forKey: "gradientColor_2")
                    } else {
                        UserDefaults.standard.removeObject(
                            forKey: "gradientColor_2")
                    }

                    if theme[0]["icon_color"].stringValue != "" {
                        let color = colorFromRGB(
                            rgbString: theme[0]["icon_color"].stringValue)
                        UserDefaults.standard.saveColor(
                            color, forKey: "iconColor")
                    } else {
                        UserDefaults.standard.removeObject(forKey: "iconColor")
                    }
                    ...
                    if theme[0]["background_image"].stringValue != "" {
                        self.headerImage.sd_setImage(
                            with: URL(
                                string: theme[0]["background_image"].stringValue
                ...
                self.userPic.sd_setImage(
                    with: URL(
                        string: self.profileJSON!["profile_photo"].stringValue),
                    for: .normal,
                    placeholderImage: UIImage(named: "logo_circle"))
                self.userName.text =
                    "\(self.profileJSON![self.firstNameKey()].stringValue) \(self.profileJSON![self.lastNameKey()].stringValue)"  // as AnyObject as? String
                self.userPosition.text =
                    self.profileJSON!["designation_name"].stringValue
                ...
                self.tabBarController!.tabBar.items!.last!.badgeColor =
                    UIColor.customThemeColor()

                self.quickMenuJSON = json["data"][0]["quickmenu"]
                quickBtn1.sd_setImage(
                    with: URL(
                        string: self.quickMenuJSON![0]["menu_image_url"]
                            .stringValue), for: .normal,
                    placeholderImage: UIImage(named: "logo_circle"))
                quickBtn2.sd_setImage(
                    with: URL(
                        string: self.quickMenuJSON![1]["menu_image_url"]
                            .stringValue), for: .normal,
                    placeholderImage: UIImage(named: "logo_circle"))
                quickBtn3.sd_setImage(
                    with: URL(
                        string: self.quickMenuJSON![2]["menu_image_url"]
                            .stringValue), for: .normal,
                    placeholderImage: UIImage(named: "logo_circle"))
                quickBtn4.sd_setImage(
                    with: URL(
                        string: self.quickMenuJSON![3]["menu_image_url"]
                            .stringValue), for: .normal,
                    placeholderImage: UIImage(named: "logo_circle"))
                ...
                quickLabel1.text =
                    self.quickMenuJSON![0][menuNameKey()].stringValue
                quickLabel2.text =
                    self.quickMenuJSON![1][menuNameKey()].stringValue
                quickLabel3.text =
                    self.quickMenuJSON![2][menuNameKey()].stringValue
                quickLabel4.text =
                    self.quickMenuJSON![3][menuNameKey()].stringValue
                
                quickBtn1.isUserInteractionEnabled = true
                quickBtn2.isUserInteractionEnabled = true
                quickBtn3.isUserInteractionEnabled = true
                quickBtn4.isUserInteractionEnabled = true
                ...
                if self.annoucementJSON!.count > 0 {
                    startAutoScroll()
                    announcementPageControl.numberOfPages =
                        annoucementJSON!.count
                    if firstTime {
                        self.announcementCollectionView.scrollToItem(
                ...
                if self.recommendJSON!.count > 0
                    && json["data"][0]["isreward"] == "1"
                {
                ...
                if json["data"][0]["privacy_policy_accept"] == "0" {
                    let vc =
                        UIStoryboard.loginStoryBoard.instantiateViewController(
                            withIdentifier: "PrivacyPolicy") as! PrivacyPolicy
                    ...
                    let vc =
                        UIStoryboard.mainStoryBoard.instantiateViewController(
                            withIdentifier: "Web") as! Web
                    vc.titleString = "HOME_Admin_Setting".localized()
                    vc.webUrlString =
                        json["data"][0]["complete_setting_url"].stringValue
                    self.navigationController!.pushViewController(
                        vc, animated: true)
                    ...
                    vc.titleString = ""
                    vc.webUrlString =
                        json["data"][0]["flag_expire_url"].stringValue
                    ...
                    self.popupPic.sd_setImage(
                        with: URL(
                            string: json["data"][0]["popup"][0]["image_url"]
                                .stringValue), placeholderImage: nil)
                    self.popupTitle.text =
                        json["data"][0]["popup"][0]["title"].stringValue
                    self.popupDescription.text =
                        json["data"][0]["popup"][0]["detail"].stringValue
    ...
    @IBAction func profileClick(_ sender: UIButton) {
        let vc =
            UIStoryboard.mainStoryBoard.instantiateViewController(
                withIdentifier: "Profile") as! Profile
        vc.whoMode = .Me
    ...
    @IBAction func quickMenuClick(_ sender: UIButton) {
        ...
        case "QUICK_CHECK_IN":  //Check In
            if CLLocationManager.locationServicesEnabled() {
                ...
                case .notDetermined, .restricted, .denied:
                    ...
                    let alertMainBody = alertService.alertMainWithBody(
                        title: "HOME_Location_Denied".localized(),
                        body: "HOME_Location_Allow".localized(),
                        buttonTitle: "GO_Setting".localized(),
                ...
                case .authorizedAlways, .authorizedWhenInUse:
                    ...
                    let mapsController =
                        mainboard.instantiateViewController(
                            withIdentifier: "CheckInMap") as! CheckInMap
                    let sheetController =
                        mainboard.instantiateViewController(
                            withIdentifier: "CheckIn") as! CheckIn
                    ...
                    self.navigationController!.pushViewController(
                        containerController, animated: true)
                ...
                let alertMainBody = alertService.alertMainWithBody(
                    title: "HOME_Location_Disable".localized(),
                    body: "HOME_Location_Check".localized(),
                    buttonTitle: "OK".localized(), buttonColor: .themeColor
                ) {
        ...
        case "QUICK_ATTENDANCE":  //Attendance
            let vc =
                UIStoryboard.attendanceStoryBoard.instantiateViewController(
                    withIdentifier: "Attendance") as! Attendance
            self.navigationController!.pushViewController(vc, animated: true)
        case "QUICK_LEAVE_REQUEST":  //Leaves
            let vc =
                UIStoryboard.attendanceStoryBoard.instantiateViewController(
                    withIdentifier: "Leave") as! Leave
            self.navigationController!.pushViewController(vc, animated: true)
        case "QUICK_OT":  //OT
            let vc =
                UIStoryboard.attendanceStoryBoard.instantiateViewController(
                    withIdentifier: "OT") as! OT
            self.navigationController!.pushViewController(vc, animated: true)
    ...
    func numberOfNotches(
        in containerViewController: OverlayContainerViewController
    ) -> Int {
    ...
    func overlayContainerViewController(
        ...
        case .medium:
            if UIDevice.current.hasNotch {  //iphone X or upper
    ...
    @IBAction func seeAllReward(_ sender: UIButton) {
        let vc =
            UIStoryboard.rewardStoryBoard.instantiateViewController(
                withIdentifier: "RewardList") as! RewardList
        vc.mode = .promotion
        self.navigationController!.pushViewController(vc, animated: true)
    }
    ...
    func collectionView(
        ...
        if collectionView == categoryCollectionView {  //Category
            ...
            cell.cellImage.sd_setImage(
                with: URL(string: cellArray["menu_image_url"].stringValue),
                placeholderImage: UIImage(named: "logo_circle"))
            ...
            let cell =
                collectionView.dequeueReusableCell(
                    withReuseIdentifier: "AnnouncementCell", for: indexPath)
                as! AnnouncementCell

            cell.setRoundAndShadow()
            cell.cellImage.sd_setImage(
                with: URL(string: cellArray["banner_url"].stringValue),
                placeholderImage: UIImage(named: "logo_circle"))
            ...
            let cell =
                collectionView.dequeueReusableCell(
                    withReuseIdentifier: "PromotionCell", for: indexPath)
                as! CategoryCell
...
extension Home: UICollectionViewDelegate {
    ...
    func collectionView(
        ...
        if collectionView == categoryCollectionView {  //Category
            ...
            case "MAIN_EDOCUMENT":
                let vc =
                    UIStoryboard.eDocumentStoryBoard.instantiateViewController(
                        withIdentifier: "EDocMenu") as! EDocMenu
                self.navigationController!.pushViewController(
                    vc, animated: true)
            ...
            case "MAIN_REPORT":
                let vc =
                    UIStoryboard.eDocumentStoryBoard.instantiateViewController(
                        withIdentifier: "ReportMenu") as! ReportMenu
                self.navigationController!.pushViewController(
                    vc, animated: true)
            ...
            case "MAIN_WARNING":
                let vc =
                    UIStoryboard.eDocumentStoryBoard.instantiateViewController(
                        withIdentifier: "Warning") as! Warning
                self.navigationController!.pushViewController(
                    vc, animated: true)
            ...
            case "MAIN_WARNING_HEAD":
                let vc =
                    UIStoryboard.eDocumentStoryBoard.instantiateViewController(
                        withIdentifier: "WarningHead") as! WarningHead
                self.navigationController!.pushViewController(
                    vc, animated: true)
            ...
            case "MAIN_SWAP":
                let vc =
                    UIStoryboard.attendanceStoryBoard.instantiateViewController(
                        withIdentifier: "SwapShift") as! SwapShift
            ...
            if cellArray["reward_id"] == "0" {
                ...
                let vc =
                    UIStoryboard.rewardStoryBoard.instantiateViewController(
                        withIdentifier: "RewardDetail") as! RewardDetail
                vc.mode = .redeem
    ...
    @objc func startAutoScroll() {
        ...
        announcementTimer = Timer.scheduledTimer(
            timeInterval: 4.0, target: self,
            selector: #selector(self.autoScrollAnnouncement), userInfo: nil,
            repeats: true)
    }
    ...
    @objc func autoScrollAnnouncement() {
        ...
        if announcementIndex < announcementCollectionView.numberOfItems(
            inSection: 0) - 1
        {
            announcementIndex += 1
        } else {
    ...
    func scrollViewDidEndDragging(
        ...
        //        }
        if scrollView.tag == 2 {
            let visibleCells = announcementCollectionView
                .indexPathsForVisibleItems.sorted()
